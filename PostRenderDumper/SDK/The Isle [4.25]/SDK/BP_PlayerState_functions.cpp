...
// Function BP_PlayerState.BP_PlayerState_C.PlayerStateChanged
// (BlueprintAuthorityOnly, Event, Public, BlueprintCallable, BlueprintEvent)

void ABP_PlayerState_C::PlayerStateChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerState_C", "PlayerStateChanged");
...
void ABP_PlayerState_C::UpdateCachedUnlockedCharacters()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerState_C", "UpdateCachedUnlockedCharacters");
