...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04239338;
	constexpr int32 AppendString      = 0x00CCFF30;
	constexpr int32 GNames            = 0x04220940;
	constexpr int32 GWorld            = 0x0437B318;
	constexpr int32 ProcessEvent      = 0x00EBA5A0;
