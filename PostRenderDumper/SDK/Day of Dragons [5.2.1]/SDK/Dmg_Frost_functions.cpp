...
void UDmg_Frost_C::CalculateDamage(double InMitigation, double InMultiplier, double InDamage, double InArmor, double InHealth, const struct FStruct_StatMutations& Mutations, Enum_GeneticGrades GeneticQuality, double* OutArmor, double* OutHealth) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Dmg_Frost_C", "CalculateDamage");

	Params::Dmg_Frost_C_CalculateDamage Parms{};
