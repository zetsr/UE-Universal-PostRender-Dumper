...
public:
	...
	static TArray<struct FColor> FlipPixelChannelsBA(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> FlipPixelChannelsGA(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> FlipPixelChannelsGB(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> FlipPixelChannelsRA(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> FlipPixelChannelsRB(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> FlipPixelChannelsRG(const TArray<struct FColor>& Pixels);
	...
	static TArray<struct FColor> GrayscalePixels(const TArray<struct FColor>& Pixels);
	...
	static TArray<struct FColor> InvertPixelChannelA(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> InvertPixelChannelB(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> InvertPixelChannelG(const TArray<struct FColor>& Pixels);
	static TArray<struct FColor> InvertPixelChannelR(const TArray<struct FColor>& Pixels);
