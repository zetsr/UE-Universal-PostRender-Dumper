...
// Parameters:
// class APlayerController*                ConsideringPlayer                                      (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FDialogueNode UDialogue::GetNodeById(int32 ID, bool* Found)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Dialogue", "GetNodeById");

	Params::Dialogue_GetNodeById Parms{};
...
// bool                                    isRichText                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Chars                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString*                          outputString                                           (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool*                                   finished                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UDialogueUserWidget::GetFirstChars(const class FString& originalString, bool isRichText, int32 Chars, class FString* outputString, bool* finished)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DialogueUserWidget", "GetFirstChars");

	Params::DialogueUserWidget_GetFirstChars Parms{};

	Parms.originalString = std::move(originalString);
	Parms.isRichText = isRichText;
	Parms.Chars = Chars;
