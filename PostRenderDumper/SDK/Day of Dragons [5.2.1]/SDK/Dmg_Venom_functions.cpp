...
void UDmg_Venom_C::CalculateDamage(double InMitigation, double InMultiplier, double InDamage, double InArmor, double InHealth, const struct FStruct_StatMutations& Mutations, Enum_GeneticGrades GeneticQuality, double* OutArmor, double* OutHealth) const
{
...
void UDmg_Venom_C::GetSelfDamageType(Enum_DmgTypes* DamageType) const
{
	static class UFunction* Func = nullptr;
