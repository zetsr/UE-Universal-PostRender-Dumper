...
// bool                                    DOD_Is_Using_Random_Weather                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Change_Weather(class UUDS_Weather_Settings_C* New_Weather_Type, double Time_To_Transition_To_New_Weather__Seconds_, bool DOD_Is_Using_Random_Weather)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DOD_Is_Using_Random_Weather = DOD_Is_Using_Random_Weather;
