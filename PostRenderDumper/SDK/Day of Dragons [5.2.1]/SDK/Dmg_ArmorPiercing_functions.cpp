...
#include "Dmg_ArmorPiercing_classes.hpp"
#include "Dmg_ArmorPiercing_parameters.hpp"
...
void UDmg_ArmorPiercing_C::CalculateDamage(double InMitigation, double InMultiplier, double InDamage, double InArmor, double InHealth, const struct FStruct_StatMutations& Mutations, Enum_GeneticGrades GeneticQuality, double* OutArmor, double* OutHealth) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Dmg_ArmorPiercing_C", "CalculateDamage");

	Params::Dmg_ArmorPiercing_C_CalculateDamage Parms{};
...
void UDmg_ArmorPiercing_C::GetSelfDamageType(Enum_DmgTypes* DamageType) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Dmg_ArmorPiercing_C", "GetSelfDamageType");

	Params::Dmg_ArmorPiercing_C_GetSelfDamageType Parms{};
