...
public:
	...
	TMulticastInlineDelegate<void(float CurrentOffset)> OnUserScrolled;                              // 0x0850(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_860[0x18];                                     // 0x0860(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
