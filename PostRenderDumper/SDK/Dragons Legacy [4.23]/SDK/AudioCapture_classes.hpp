...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x0640(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_644[0xAC];                                     // 0x0644(0x00AC)(Fixing Struct Size After Last Property [ Dumper-7 ])
