...
// 0x0010 (0x0038 - 0x0028)
class UDatasmithCommonTessellationOptions final : public UObject
{
public:
...
public:
	...
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                   // 0x0248(0x0050)(Edit, ZeroConstructor, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)
