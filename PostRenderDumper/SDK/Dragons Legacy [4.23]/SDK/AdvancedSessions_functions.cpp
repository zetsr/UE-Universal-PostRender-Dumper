...
void UAdvancedSessionsLibrary::GetCurrentSessionID_AsString(class FString* SessionId)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetSessionSettings(int32* NumConnections, int32* NumPrivateConnections, bool* bIsLAN, bool* bIsDedicated, bool* bAllowInvites, bool* bAllowJoinInProgress, bool* bIsAnticheatEnabled, int32* BuildUniqueID, TArray<struct FSessionPropertyKeyPair>* ExtraSettings, EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::IsPlayerInSession(const struct FBPUniqueNetId& PlayerToCheck, bool* bIsInSession)
{
	static class UFunction* Func = nullptr;
