...
{
public:
	TMulticastInlineDelegate<void(const TArray<struct FBPSteamGroupOfficer>& OfficerList)> OnSuccess; // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<struct FBPSteamGroupOfficer>& OfficerList)> OnFailure; // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	TMulticastInlineDelegate<void(const struct FBPSteamWorkshopItemDetails& WorkShopDetails)> OnSuccess; // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FBPSteamWorkshopItemDetails& WorkShopDetails)> OnFailure; // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
