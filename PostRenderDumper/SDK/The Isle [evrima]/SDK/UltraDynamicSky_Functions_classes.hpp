...
public:
	...
	static void Apply_Sky_Configuration_·_𝖴𝖣𝖲(class UUDS_Sky_Configuration_C* Configuration, class UObject* __WorldContext);
	...
	static void Get_Time_of_Day_as_String_·_𝖴𝖣𝖲(bool Include_Seconds, bool Pad_Hour_with_0, bool Two4_Hour_Time, class UObject* __WorldContext, class FString* Out);
	...
	static void Offset_Time_by_Time_Span_·_𝖴𝖣𝖲(const struct FTimespan& Timespan, class UObject* __WorldContext);
	static void Offset_Time_of_Day_by_Hours_·_𝖴𝖣𝖲(double Hours, class UObject* __WorldContext);
	...
	static void Set_Time_of_Day_with_String_·_𝖴𝖣𝖲(const class FString& Time_String, class UObject* __WorldContext);
	...
	void Lerp_Yaw_Angles(double Angle_A, double Angle_B, double Alpha, class UObject* __WorldContext, double* Out);
