...
void UUDW_Temperature_Manager_C::Get_Current_Value(double* Out)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UDW_Temperature_Manager_C", "Get Current Value");

	Params::UDW_Temperature_Manager_C_Get_Current_Value Parms{};
