...
void UWeatherMask_C::Draw_to_Height_Canvas(class UCanvas* Height_Canvas, class UUDS_RenderTarget_State_C* Target_State, class UMaterialInstanceDynamic* Draw_MID, bool* Success)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WeatherMask_C", "Draw to Height Canvas");

	Params::WeatherMask_C_Draw_to_Height_Canvas Parms{};
...
void UWeatherMask_C::Draw_to_Mask_Canvas(class UUDS_RenderTarget_State_C* Target_State, class UCanvas* Mask_Canvas, class AUltra_Dynamic_Weather_C* UDW_0, bool* Success)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WeatherMask_C", "Draw to Mask Canvas");

	Params::WeatherMask_C_Draw_to_Mask_Canvas Parms{};
...
void UWeatherMask_C::Prepare_for_Drawing(class AUltra_Dynamic_Weather_C* UDW_0)
{
	static class UFunction* Func = nullptr;
...
// Function WeatherMask.WeatherMask_C.Mask Outside of Target
// (Public, BlueprintCallable, BlueprintEvent)

void UWeatherMask_C::Mask_Outside_of_Target()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WeatherMask_C", "Mask Outside of Target");
