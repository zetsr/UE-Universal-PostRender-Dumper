...
// Parameters:
// const TArray<class ULandscapeGrassType*>ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

const TArray<class ULandscapeGrassType*> ULandscapeComponent::GetGrassTypesBP() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeComponent", "GetGrassTypesBP");

	Params::LandscapeComponent_GetGrassTypesBP Parms{};
