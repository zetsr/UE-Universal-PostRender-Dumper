...
// Function UDS_Utility_Opener_Interface.UDS_Utility_Opener_Interface_C.Open Volumetric Cloud Painter
// (Public, BlueprintCallable, BlueprintEvent)

void IUDS_Utility_Opener_Interface_C::Open_Volumetric_Cloud_Painter()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("UDS_Utility_Opener_Interface_C", "Open Volumetric Cloud Painter");
