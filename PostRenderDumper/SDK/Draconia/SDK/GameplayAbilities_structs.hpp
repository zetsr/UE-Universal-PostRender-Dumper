...
// Enum GameplayAbilities.ECancelAbilityTagsGameplayEffectComponentMode
// NumValues: 0x0003
enum class ECancelAbilityTagsGameplayEffectComponentMode : uint8
{
	OnApplication                            = 0,
	OnExecution                              = 1,
	ECancelAbilityTagsGameplayEffectComponentMode_MAX = 2,
};
...
// Enum GameplayAbilities.EGameplayTagReplicationState
// NumValues: 0x0005
enum class EGameplayTagReplicationState : uint8
{
	...
	CountToOwner                             = 2,
	TagAndCountToAll                         = 3,
	EGameplayTagReplicationState_MAX         = 4,
};
...
public:
	...
	uint8                                         Pad_2DD[0x8B];                                     // 0x02DD(0x008B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	bool                                          bPredictionRejected;                               // 0x0001(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UScriptStruct*                          BaseStructType;                                    // 0x0010(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
struct FGameplayTagCountContainer final
{
public:
	uint8                                         Pad_0[0xE8];                                       // 0x0000(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                Owner;                                             // 0x00E8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
};
...
// ScriptStruct GameplayAbilities.GameplayTagCountItem
// 0x0010 (0x0010 - 0x0000)
struct FGameplayTagCountItem final
{
public:
...
DUMPER7_ASSERTS_FGameplayTagCountItem;
...
// ScriptStruct GameplayAbilities.GameplayTagCountContainerNetSerializerConfig
// 0x0000 (0x0010 - 0x0010)
struct FGameplayTagCountContainerNetSerializerConfig final : public FNetSerializerConfig
{
};
DUMPER7_ASSERTS_FGameplayTagCountContainerNetSerializerConfig;

// ScriptStruct GameplayAbilities.NetGameplayTagCountContainerStateForNetSerialize
// 0x0010 (0x0010 - 0x0000)
struct FNetGameplayTagCountContainerStateForNetSerialize final
{
public:
	TArray<struct FGameplayTagCountItem>          TagStates;                                         // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FNetGameplayTagCountContainerStateForNetSerialize;
