...
// Function AssetRegistry.AssetRegistryHelpers.GetDerivedClassAssetData
// 0x0020 (0x0020 - 0x0000)
struct AssetRegistryHelpers_GetDerivedClassAssetData final
{
public:
	TArray<struct FTopLevelAssetPath>             InBaseClasses;                                     // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<struct FAssetData>                     OutDerivedClassAssetData;                          // 0x0010(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_AssetRegistryHelpers_GetDerivedClassAssetData;
...
public:
	...
	TSet<struct FTopLevelAssetPath>               ExcludedClassNames;                                // 0x0010(0x0050)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	TSet<struct FTopLevelAssetPath>               OutDerivedClassNames;                              // 0x0060(0x0050)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   PackageName;                                       // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAssetRegistryDependencyOptions        DependencyOptions;                                 // 0x0008(0x0007)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	class FName                                   PackageName;                                       // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAssetRegistryDependencyOptions        ReferenceOptions;                                  // 0x0008(0x0007)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_F[0x1];                                        // 0x000F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
