...
public:
	...
	TSet<class FString>                           SimulationGroups;                                  // 0x0008(0x0050)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FDataflowSimulationTime                SimulationTime;                                    // 0x0240(0x000C)(Transient, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class FString>                         SimulationGroups;                                  // 0x0250(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FDataflowSimulationProperty>    PhysicsSolvers;                                    // 0x0250(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FDataflowSimulationProperty>    SimulationProxies;                                 // 0x0240(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<struct FDataflowSimulationProperty>    FilteredProxies;                                   // 0x0250(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<class FString>                         SimulationGroups;                                  // 0x0260(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
