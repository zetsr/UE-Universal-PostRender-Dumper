...
struct InterchangeGenericAudioPipeline_CreateSoundWaveFactoryNode final
{
public:
	const class UInterchangeAudioSoundWaveNode*   SoundWaveNode;                                     // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeAudioSoundWaveFactoryNode*  ReturnValue;                                       // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_InterchangeGenericAudioPipeline_CreateSoundWaveFactoryNode;
