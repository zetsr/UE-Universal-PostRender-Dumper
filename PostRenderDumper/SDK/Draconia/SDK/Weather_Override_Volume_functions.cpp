...
// double*                                 Material_Alpha                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AWeather_Override_Volume_C::Sample_Point_for_Current_Alpha(const struct FVector& Location, double* Alpha, double* Material_Alpha)
{
	static class UFunction* Func = nullptr;
	...
	if (Material_Alpha != nullptr)
		*Material_Alpha = Parms.Material_Alpha;
}
...
double AWeather_Override_Volume_C::Get_Scaled_Transition_Width()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Weather_Override_Volume_C", "Get Scaled Transition Width");

	Params::Weather_Override_Volume_C_Get_Scaled_Transition_Width Parms{};
...
// Parameters:
// const struct FVector2D&                 Point                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector2D&                 E1                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector2D&                 E2                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   Positive                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AWeather_Override_Volume_C::Edge_to_Point_Sign_F(const struct FVector2D& Point, const struct FVector2D& E1, const struct FVector2D& E2, bool* Positive)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Weather_Override_Volume_C", "Edge to Point Sign F");

	Params::Weather_Override_Volume_C_Edge_to_Point_Sign_F Parms{};

	Parms.Point = std::move(Point);
	Parms.E1 = std::move(E1);
	Parms.E2 = std::move(E2);

	UObject::ProcessEvent(Func, &Parms);

	if (Positive != nullptr)
		*Positive = Parms.Positive;
}
