...
// TArray<EUDS_CachedProperties>&          Properties_in_Cache_Group                              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void AUltra_Dynamic_Sky_C::Update_Cache_Group_Boolean(EUDS_Cache_Group Group, TArray<EUDS_CachedProperties>& Properties_in_Cache_Group)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Group = Group;
	Parms.Properties_in_Cache_Group = std::move(Properties_in_Cache_Group);

	UObject::ProcessEvent(Func, &Parms);

	Properties_in_Cache_Group = std::move(Parms.Properties_in_Cache_Group);
}
...
void AUltra_Dynamic_Sky_C::Update_Atlas_Light_Vectors()
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.Scale Light Shaft Bloom
// (Protected, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// double                                  Bloom_Scale_Float                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::Scale_Light_Shaft_Bloom(class UDirectionalLightComponent* Light, const struct FVector& Forward_Vector, double Bloom_Scale_Float)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "Scale Light Shaft Bloom");

	Params::Ultra_Dynamic_Sky_C_Scale_Light_Shaft_Bloom Parms{};

	Parms.Light = Light;
	Parms.Forward_Vector = std::move(Forward_Vector);
	Parms.Bloom_Scale_Float = Bloom_Scale_Float;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.Construct Occlusion State
// (Public, BlueprintCallable, BlueprintEvent)

void AUltra_Dynamic_Sky_C::Construct_Occlusion_State()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "Construct Occlusion State");
...
// ECompareOperationEnum*                  Comparison                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::Compare_Version_Strings(const class FString& Version_String_A, const class FString& Version_String_B, ECompareOperationEnum* Comparison)
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.Check to Convert Static Post Process Settings
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)

void AUltra_Dynamic_Sky_C::Check_to_Convert_Static_Post_Process_Settings()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "Check to Convert Static Post Process Settings");
