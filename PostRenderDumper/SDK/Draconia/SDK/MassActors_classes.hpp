...
public:
	...
	TArray<class AActor*>                         ActorsToDestroy;                                   // 0x0050(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<class AActor*>                         DeactivatedActorsToDestroy;                        // 0x0060(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UMassSpawnerSubsystem*                  SpawnerSystem;                                     // 0x0050(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UMassSimulationSubsystem*               SimulationSystem;                                  // 0x0058(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	...
	class UMassReplicationSubsystem*              ReplicationSubsystem;                              // 0x0100(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	TMap<struct FMassNetworkID, class UMassAgentComponent*> ReplicatedAgentComponents;               // 0x0108(0x0050)(ExportObject, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
// Class MassActors.MassSceneComponentVelocityToMassTranslator
// 0x0350 (0x0430 - 0x00E0)
class UMassSceneComponentVelocityToMassTranslator final : public UMassTranslator
{
public:
	uint8                                         Pad_E0[0x350];                                     // 0x00E0(0x0350)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MassSceneComponentVelocityToMassTranslator")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MassSceneComponentVelocityToMassTranslator")
	}
	static class UMassSceneComponentVelocityToMassTranslator* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMassSceneComponentVelocityToMassTranslator>();
	}
};
DUMPER7_ASSERTS_UMassSceneComponentVelocityToMassTranslator;
