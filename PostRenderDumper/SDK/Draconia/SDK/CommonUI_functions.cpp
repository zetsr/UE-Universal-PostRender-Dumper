...
void UCommonButtonBase::SetAllowDragDrop(bool bInAllowDragDrop)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonButtonBase", "SetAllowDragDrop");

	Params::CommonButtonBase_SetAllowDragDrop Parms{};
...
// Function CommonUI.CommonLazyWidget.LoadLazyContent
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
...
void UCommonLazyWidget::LoadLazyContent()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CommonLazyWidget", "LoadLazyContent");
...
// Parameters:
// const TSoftClassPtr<class UClass>       SoftWidget                                             (ConstParm, Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const TDelegate<void(class UUserWidget* Widget)>&OnCreatedCallback                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonLazyWidget::SetLazyContentWithCallback(const TSoftClassPtr<class UClass> SoftWidget, const TDelegate<void(class UUserWidget* Widget)>& OnCreatedCallback)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonLazyWidget", "SetLazyContentWithCallback");

	Params::CommonLazyWidget_SetLazyContentWithCallback Parms{};

	Parms.SoftWidget = SoftWidget;
	Parms.OnCreatedCallback = OnCreatedCallback;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    InCacheChildren                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UCommonWidgetCarousel::SetCacheChildren(bool InCacheChildren)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CommonWidgetCarousel", "SetCacheChildren");

	Params::CommonWidgetCarousel_SetCacheChildren Parms{};

	Parms.InCacheChildren = InCacheChildren;
...
bool UCommonWidgetCarousel::GetCacheChildren() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CommonWidgetCarousel", "GetCacheChildren");

	Params::CommonWidgetCarousel_GetCacheChildren Parms{};
