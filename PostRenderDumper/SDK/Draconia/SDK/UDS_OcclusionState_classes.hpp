...
public:
	...
	class UUDS_OcclusionSettings_C*               Previous_Settings_Asset;                           // 0x01A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

public:
	void Save_Unchanging_Values();
	void Editor_Check_Settings_Change();
