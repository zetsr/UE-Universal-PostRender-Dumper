...
enum class EInterchangeAnimationPayLoadType : uint8
{
	...
	GEOMETRY_CACHE_TRANSFORM                 = 6,
	EInterchangeAnimationPayLoadType_MAX     = 7,
};
...
// Enum InterchangeNodes.EInterchangeGroomPayLoadType
// NumValues: 0x0003
enum class EInterchangeGroomPayLoadType : uint8
{
	STATIC                                   = 0,
	ANIMATED                                 = 1,
	EInterchangeGroomPayLoadType_MAX         = 2,
};

// Enum InterchangeNodes.EInterchangeGroomCacheAttributes
// NumValues: 0x0009
enum class EInterchangeGroomCacheAttributes : uint8
{
	...
	EInterchangeGroomCacheAttributes_MAX     = 8,
};
...
// Enum InterchangeNodes.EInterchangeSkyLightSourceType
// NumValues: 0x0003
enum class EInterchangeSkyLightSourceType : uint8
{
	CapturedScene                            = 0,
	SpecifiedCubemap                         = 1,
	EInterchangeSkyLightSourceType_MAX       = 2,
};
...
// ScriptStruct InterchangeNodes.InterchangeGroomPayloadKey
// 0x0018 (0x0018 - 0x0000)
struct FInterchangeGroomPayloadKey final
{
public:
	class FString                                 UniqueID;                                          // 0x0000(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInterchangeGroomPayLoadType                  Type;                                              // 0x0010(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_FInterchangeGroomPayloadKey;
