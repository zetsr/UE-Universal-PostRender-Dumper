...
// Function Landscape.LandscapeComponent.GetGrassTypesBP
// 0x0010 (0x0010 - 0x0000)
struct LandscapeComponent_GetGrassTypesBP final
{
public:
	TArray<class ULandscapeGrassType*>            ReturnValue;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_LandscapeComponent_GetGrassTypesBP;
