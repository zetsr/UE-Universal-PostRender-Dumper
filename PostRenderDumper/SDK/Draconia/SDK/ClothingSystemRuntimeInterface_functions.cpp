...
// Parameters:
// const class FName                       ClothingAssetName                                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UClothingInteractor* UClothingSimulationInteractor::GetClothingInteractor(const class FName ClothingAssetName) const
{
	static class UFunction* Func = nullptr;
