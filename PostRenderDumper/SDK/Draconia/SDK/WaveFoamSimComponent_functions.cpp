...
// class UShallowWaterSimComponent_C*      ShallowWater_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UWaveFoamSimComponent_C::InitializeWaveFoamSim(int32 res_0, double WorldSize, double Fading, double TimeBias, class AWaterBody* WaterBody, class UShallowWaterSimComponent_C* ShallowWater_0)
{
	static class UFunction* Func = nullptr;
