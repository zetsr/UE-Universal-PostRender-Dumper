...
#include "DmgType_Melee_StonePick_LifeSupport_classes.hpp"
#include "DmgType_Melee_StonePick_LifeSupport_parameters.hpp"
...
float UDmgType_Melee_StonePick_LifeSupport_C::BPAdjustDamage(class AActor* Victim, float IncomingDamage, const struct FDamageEvent& TheDamageEvent, class AController* EventInstigator, class AActor* DamageCauser) const
{
	...
	Params::DmgType_Melee_StonePick_LifeSupport_C_BPAdjustDamage Parms{};
