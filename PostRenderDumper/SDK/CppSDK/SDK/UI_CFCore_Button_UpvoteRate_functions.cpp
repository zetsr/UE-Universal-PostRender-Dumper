...
#include "UI_CFCore_Button_UpvoteRate_classes.hpp"
...
void UUI_CFCore_Button_UpvoteRate_C::GetRootCFWidget(class UPanelWidget** RootPanelWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_CFCore_Button_UpvoteRate_C", "GetRootCFWidget");

	Params::UI_CFCore_Button_UpvoteRate_C_GetRootCFWidget Parms{};
