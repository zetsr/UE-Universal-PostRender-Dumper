...
class UASAUI_NewsCarouselTemplate_Entry_CTA_C final : public UUI_MenuCarouselEntryWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_ASAUI_NewsCarouselTemplate_Entry_CTA(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("ASAUI_NewsCarouselTemplate_Entry_CTA_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ASAUI_NewsCarouselTemplate_Entry_CTA_C")
	}
	static class UASAUI_NewsCarouselTemplate_Entry_CTA_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UASAUI_NewsCarouselTemplate_Entry_CTA_C>();
	}
};
DUMPER7_ASSERTS_UASAUI_NewsCarouselTemplate_Entry_CTA_C;
