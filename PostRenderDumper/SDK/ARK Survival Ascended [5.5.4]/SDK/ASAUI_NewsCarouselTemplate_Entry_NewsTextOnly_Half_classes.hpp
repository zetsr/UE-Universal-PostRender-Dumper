...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("ASAUI_NewsCarouselTemplate_Entry_NewsTextOnly_Half_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ASAUI_NewsCarouselTemplate_Entry_NewsTextOnly_Half_C")
	}
	static class UASAUI_NewsCarouselTemplate_Entry_NewsTextOnly_Half_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UASAUI_NewsCarouselTemplate_Entry_NewsTextOnly_Half_C>();
	}
};
DUMPER7_ASSERTS_UASAUI_NewsCarouselTemplate_Entry_NewsTextOnly_Half_C;
