...
// (Native, Public, BlueprintCallable)
// Parameters:
// const TArray<struct FEOSUserInterface_CandidateEOSAccount>&SelectedCandidates_0                                   (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// const TArray<struct FEOSUserInterface_CandidateEOSAccount>&AvailableCandidates                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
void IEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform::SetupUserInterface(class UEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform_Context* Context, const TArray<struct FEOSUserInterface_CandidateEOSAccount>& AvailableCandidates)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EOSUserInterface_LinkEOSAccountsAgainstCrossPlatform", "SetupUserInterface");
...
// (Native, Public, BlueprintCallable)
// Parameters:
// const struct FEOSUserInterface_CandidateEOSAccount&SelectedCandidate                                      (Parm, NativeAccessSpecifierPublic)
...
void IEOSUserInterface_SelectEOSAccount::SetupUserInterface(class UEOSUserInterface_SelectEOSAccount_Context* Context, const TArray<struct FEOSUserInterface_CandidateEOSAccount>& AvailableCandidates)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EOSUserInterface_SelectEOSAccount", "SetupUserInterface");
...
// const class FString&                    EpicAccountName                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void IEOSUserInterface_SwitchToCrossPlatformAccount::SetupUserInterface(class UEOSUserInterface_SwitchToCrossPlatformAccount_Context* Context, const class FString& EpicAccountName)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EOSUserInterface_SwitchToCrossPlatformAccount", "SetupUserInterface");
