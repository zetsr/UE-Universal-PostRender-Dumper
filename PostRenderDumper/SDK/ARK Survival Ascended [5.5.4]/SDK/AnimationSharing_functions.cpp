...
// class FName                             CustomTag                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAnimationSharingManager::RegisterActorWithSkeletonAndTagBP(class AActor* InActor, const class USkeleton* SharingSkeleton, class FName CustomTag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimationSharingManager", "RegisterActorWithSkeletonAndTagBP");

	Params::AnimationSharingManager_RegisterActorWithSkeletonAndTagBP Parms{};
...
void UAnimationSharingManager::UnregisterActor(class AActor* InActor)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AnimationSharingManager", "UnregisterActor");

	Params::AnimationSharingManager_UnregisterActor Parms{};
