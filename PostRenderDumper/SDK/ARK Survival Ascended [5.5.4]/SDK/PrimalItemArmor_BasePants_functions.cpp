...
class USoundBase* UPrimalItemArmor_BasePants_C::OverrideCrouchingSound(class USoundBase* InSound, bool bIsProne, int32 soundState)
{
	...
	Params::PrimalItemArmor_BasePants_C_OverrideCrouchingSound Parms{};
